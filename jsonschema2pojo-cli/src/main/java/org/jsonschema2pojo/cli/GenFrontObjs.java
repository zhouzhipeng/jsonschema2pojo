 ...
 */
public final class GenFrontObjs {

    private GenFrontObjs() {
    }

    public static void genRequest() throws IOException {

        for (File file : FileUtils.listFiles(new File("/Users/zhouzhipeng/IdeaProjects/jsonschema2pojo/jsonfiles/BinanceUS/request/"), new String[]{"json"}, false)) {
            String[] args = new String[]{
                    "--source", file.getAbsolutePath(),
                    "--source-type", "json",
                    "--target", "/Users/zhouzhipeng/IdeaProjects/bnb/fiat-payment/fiatpayment-core/fiatpayment-core-api/src/main/java",
...
//                    "--serializable",
    ...
    public static void genResponse() throws IOException {
        ...
        for (File file : FileUtils.listFiles(new File("/Users/zhouzhipeng/IdeaProjects/jsonschema2pojo/jsonfiles/BinanceUS/response/"), new String[]{"json"}, false)) {
            String[] args = new String[]{
                    "--source", file.getAbsolutePath(),
                    "--source-type", "json",
                    "--target", "/Users/zhouzhipeng/IdeaProjects/bnb/fiat-payment/fiatpayment-core/fiatpayment-core-api/src/main/java",
